  ...
  return (
    <div className="w-full h-16 backdrop-filter backdrop-blur-xl bg-opacity-20 border-b flex items-center justify-center">
      <div className="max-w-7xl w-full flex items-center justify-between p-4">
        <h6 className="font-bold">BotNest</h6>
    ...
    <main className="flex min-h-screen h-fit flex-col items-center justify-center relative">
      ...
      >
        <div className="w-full h-2/4 md:h-full md:w-2/5 flex flex-col justify-center items-center md:items-start gap-8">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-md md:text-2xl">
              Interact Better Today!
            </h2>
          </div>
          <p className="max-w-md text-sm md:text-base text-zinc-500">
            Elevate customer engagement with our SaaS
            chatbot—AI-driven, efficient, and personalized
            interactions, all in one platform.
          </p>
        ...
        <div className="w-full h-2/4 md:h-full md:w-3/5 flex items-center justify-center relative -z-10">
          <Spline
            className="w-full flex scale-[.65] sm:scale-[.75] lg:scale-[.85] items-center justify-center md:justify-start"
            scene="https://prod.spline.design/kqin2e4cuV7QmxGc/scene.splinecode"
          />
        </div>
      </header>
      <section
      ...
      >
        ...
        <div className="w-full h-full flex items-center justify-center flex-col gap-8 max-w-7xl">
          <h3 className="text-4xl md:text-5xl font-bold">
            Increased Productivity Has Never Been Easier!
          </h3>
